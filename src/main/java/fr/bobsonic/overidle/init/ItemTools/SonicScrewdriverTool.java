package fr.bobsonic.overidle.init.ItemTools;
...
import fr.bobsonic.overidle.gui.overlay.SonicScrewdriverOverlay;
...
public class SonicScrewdriverTool extends ItemPickaxe
{
    public SonicScrewdriverTool(ToolMaterial p_i45347_1_)
    {
        super(p_i45347_1_);
    }
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        //MinecraftForge.EVENT_BUS.register(new SonicScrewdriverOverlay());
